...
<html>
    <head>
        ...
        <meta property="og:title" content="Contato Site Suporte T�cnico Philips" />
        
        <title>Contato Site Suporte T�cnico Philips</title>
        <style type="text/css">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                                ...
                                                <img src="http://184.168.109.7/images/logo.png" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                                    ...
                                                    <tr mc:repeatable>
                                                        <td valign="top">
                                                            <div mc:edit="postcard_heading00">
                                                                <p>Olá você solicitou uma nova senha para sua conta do SuportePHI.</p>
                                                                <br />
                                                                <p>Segue abaixo o link para resetar sua senha:</p>
                                                                <br />
                                                                <a href="<?php echo $ms; ?>">Clique aqui para resetar sua senha</a>
                                                                <br/>
                                                                <p>Ou copie e cole no navegador o link abaixo:</p>
                                                                <br />
                                                                <p><?php echo $ms; ?></p>
                                                            </div>
                                                        </td>
